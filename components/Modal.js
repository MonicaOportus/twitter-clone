...
import { addDoc, onSnapshot, serverTimestamp, doc, collection } from "firebase/firestore";
            ...
            <Dialog as="div" className="fixed z-50 inset-0 pt-8" onClose={setIsOpen}>
                ...
                pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <Transition.Child
                        ...
                        leaveTo="opacity-0"
                    >
                        <Dialog.Overlay className="fixed inset-0 bg-[#5b7083]
                    ...
                    >
                        ...
                        text-left overflow-hidden shawdon-xl transform transition-all
